...
> we re-implement the _design_ of YSFlight (https://github.com/captainys/YSFLIGHT, BSD-3) as a **web app**,
...
- Controllers drive the _real_ flight model in headless tests to setpoint tolerances:
...
FLT-001, FLT-002, FLT-003, FLT-004, FLT-005, FLT-006, FLT-101, FLT-102, FLT-103, FLT-104, FLT-105, FLT-201, FLT-202, _(parallel)_ FLT-301 started
...
**Exit:** spawn → taxi → takeoff → circuit → land → stop on a converted YSFlight map. _First true milestone._
...
flight-combat sandbox that _feels_ like lunch-break YSFlight: distinct aircraft, satisfying flight,
